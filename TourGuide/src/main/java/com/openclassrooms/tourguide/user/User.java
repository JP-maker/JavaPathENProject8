...
public class User {
	...
	// CORRIGÉ : Doit être thread-safe pour les offres de voyage
	...
	/**
	 * CORRIGÉ : Ajoute une récompense à l'utilisateur seulement si une récompense
	 * pour la même attraction n'a pas déjà été attribuée.
	 *
	 * @param userReward la nouvelle récompense à ajouter.
	 */
	...
	/**
	 * CORRIGÉ : Renvoie la dernière localisation visitée, ou null si l'historique est vide.
	 * @return la dernière VisitedLocation ou null.
	 */
